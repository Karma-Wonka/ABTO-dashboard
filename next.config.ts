...
const baseConfig: NextConfig = {
  ...
  turbopack: {
    // Pin the workspace root to this project — otherwise Turbopack walks up
    // looking for a lockfile and can land on an unrelated one outside the
    // git repo (e.g. a stray pnpm-lock.yaml in $HOME).
    root: process.cwd()
  },
  images: {
    remotePatterns: [
