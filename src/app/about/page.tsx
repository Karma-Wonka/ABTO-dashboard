        ...
        <div className='space-y-8'>
          ...
          <section className='bg-card rounded-2xl border p-8 shadow-sm'>
            ...
            <p className='text-muted-foreground text-lg leading-relaxed'>
              ...
              with an email-and-password Credentials provider. Passwords are bcrypt-hashed and
              stored in the application's own database — no third-party auth service is involved.
            </p>
          </section>
