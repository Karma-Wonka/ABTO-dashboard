      ...
      <div className='mx-auto max-w-3xl space-y-8'>
        ...
        <section>
          ...
          <p className='text-muted-foreground text-base leading-relaxed'>
            ...
            with an email-and-password Credentials provider. Your password is bcrypt-hashed before
            it is ever stored, and both your account record and session are kept in this
            application's own database — no third-party authentication service receives your
            credentials.
          </p>
        </section>
